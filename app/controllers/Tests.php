<?php
	class Tests extends Controller {
		public function __construct() {
			...
			$this->transactionModel = $this->model("Test");
		}
		
		public function index(){
             $data = [
                "daterange" => "09/09/2022 - 10/10/2023",
                "testData" => "Null",
                "startDate" => substr("daterange", 0, 10),
                "endDate" => substr("daterange", 12, 11),
				"transId" => 0,
            ];
        ...
        public function updateDelivery(){
			...
			$newStartDate = date("Y-d-m H:i:s", $newStartDate);
			$newEndDate = strtotime(substr($_POST["daterange"], 12, 11));
			$newEndDate = date("Y-d-m H:i:s", $newEndDate);
			$data = [
